...
public class MainActivity extends Activity {
	...
	RelativeLayout MediaBTN;
	RelativeLayout BrowserBTN;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		MediaBTN=(RelativeLayout)findViewById(R.id.media_BTN);
		BrowserBTN=(RelativeLayout)findViewById(R.id.browser_BTN);
		MediaBTN.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(getBaseContext(), Media.class);
		...
		BrowserBTN.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View v) {
				Intent intent = new Intent(getBaseContext(), Browser.class);
				startActivity(intent);
